...
data class BloodPressureMeasurement(
    val systolic: Int, //Float,
//    val diastolic: Int, //Float,
//    val meanArterialPressure: Int, // Float,
//    val unit: ObservationUnit,
//    val timestamp: Date?,
//    val pulseRate: Int?, //Float?,
//    val userID: Int?,
...
//            val measurementStatusPresent = flags and 0x10 > 0
            ...
            val systolic = parser.getIntValue(FORMAT_UINT16) // changed from getFloat and FORMAT_SFLOAT
//            val diastolic = parser.getIntValue(FORMAT_UINT8)
//            val meanArterialPressure = parser.getIntValue(FORMAT_UINT8)
//            val timestamp = if (timestampPresent) parser.dateTime else null
//            val pulseRate = if (pulseRatePresent) parser.getIntValue(FORMAT_UINT8) else null
